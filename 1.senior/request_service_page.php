...
if (isset($_POST['submit'])) {
    $count_query = "SELECT count(*) FROM tbl_appointment WHERE time_stamp >= CURDATE() AND senior_IC = $senior_IC";
    ...
    if ($count_row['count(*)'] < 4) {
       ...
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        $_SESSION['limit'] = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
       You have reached your submission limit. Please try again tomorrow.
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
           <span aria-hidden="true">&times;</span>
       </button>
   </div>';
        ...
        <form action="" method="post" id="request-service-form" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="input-box col-auto">
                    ...
                    <br>
                    <input class="hide_file" id="imagebtn" type="file" name="image" accept="image/*">
                </div>
            </div>
            <hr>
            <div class="form-row">
