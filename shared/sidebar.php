...
<aside>
    ...
    ?>
        <div class="profile">
            ...
            ?>
                <img src="../img_upload/senior/<?php echo $row["profile_picture"]; ?>" class="img-fluid" alt="No image">
            <?php
            } else {
            ?>
                <img src="../image/profile-picture.png" class="img-fluid" alt="No image">
            <?php
            }
            ?>
        </div>
    ...
    ?>
        <div class="profile">
            <?php if ($row['profile_picture'] != NULL) {
            ?>
                <img src="../img_upload/handyman/<?php echo $row["profile_picture"]; ?>" class="img-fluid" alt="No image">
            <?php
            } else {
            ?>
                <img src="../image/profile-picture.png" class="img-fluid" alt="No image">
